...
# Script to convert model constants to internal units
...
# ---
#
# Internally, the code uses different units than the published constants for the
# decompression models do: this script contains a verbatim copy of the published
# constants so they can be easily validated. It generates a header file with the
# converted values.
#
